...
\title{RiskShield-PPO: Risk-Aware Safe Reinforcement Learning for Autonomous Construction-Site Inspection under Perception Uncertainty}
...
control, and first-person rendering. The evidence is simulation-only and does
not establish real-world safety.
\end{abstract}
...
Live evidence records ten successful CUDA inferences, annotations, and a
perception-driven state change.
